...
export default function ProDeleteButton({
  itemId,
  itemName,
  onDeleteSuccess,
}: DeleteButtonProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await instance.delete(`/products/${itemId}`, {
        headers: {
      ...
      //here, invalidate the product query to trigger a refetch
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to delete "{itemName}" product?
